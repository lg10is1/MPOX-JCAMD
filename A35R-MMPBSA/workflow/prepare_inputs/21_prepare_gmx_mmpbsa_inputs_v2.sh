...
# gmx_MMPBSA 鎺ㄨ崘涓嶈鐢ㄦ暣鏉?100 ns 姣忎竴甯с€?# 杩欓噷榛樿鍙栨渶鍚?50 ns锛屾瘡 500 ps 涓€甯э紝绾?101 甯?rep銆?B_PS="${B_PS:-50000}"
E_PS="${E_PS:-100000}"
DT_PS="${DT_PS:-500}"

# 蹇€熸祴璇曪細鏈€鍚?10 ns锛屾瘡 1000 ps 涓€甯э紝绾?11 甯?rep銆?TEST_B_PS="${TEST_B_PS:-90000}"
